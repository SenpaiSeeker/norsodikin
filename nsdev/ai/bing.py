...
class ImageGenerator:
    def __init__(self, cookies_file_path: str = "cookies.txt", logging_enabled: bool = True):
        self.auth_cookie_u = self._parse_cookie_file(cookies_file_path)
        self.base_url = "https://www.bing.com"
        self.client = httpx.AsyncClient(
            base_url=self.base_url,
            cookies={"_U": self.auth_cookie_u},
            headers={
    ...
    def _parse_cookie_file(self, file_path: str) -> str:
        ...
        raise ValueError(f"Tidak dapat menemukan cookie '_U' untuk bing.com di {file_path}")

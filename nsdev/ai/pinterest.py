...
class PinterestAPI:
    def __init__(self):
        ...
        self.session.headers.update(
            {"accept": "*/*", "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36"}
        )
    ...
    def _parse_response(self, json_data: dict) -> PinterestResponse:
        ...
        return PinterestResponse(
            status=json_data.get("status", False), data=data_list, timestamp=json_data.get("timestamp", "")
        )

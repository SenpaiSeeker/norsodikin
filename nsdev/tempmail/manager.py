...
class TempMailManager:
    ...
    async def create_temp_email(self, user_id: int) -> Optional[Dict[str, str]]:
        ...
        if account:
            ...
            email_data = {
                ...
                'token': account['token'],
                'id': account['id'],
                'created_at': TempMailUtils.format_datetime(
    ...
    async def get_message_detail(self, email: str, message_id: str, user_id: Optional[int] = None) -> Optional[Dict[str, Any]]:
        data = self._load_data()
        ...
        if message:
            ...
            message['is_verification'] = self.utils.is_verification_email(
                message.get('subject', ''),
                full_content
            )

...
class ImageManipulator(FontManager):
    ...
    async def create_fake_ig_post(
        ...
        svg_verified = '<svg viewBox="0 0 22 22" width="14" height="14"><g><path d="M20.396 11c-.018-.646-.215-1.275-.57-1.816-.354-.54-.852-.972-1.438-1.246.223-.603.27-1.264.14-1.897-.131-.634-.437-1.218-.882-1.687-.47-.445-1.053-.75-1.687-.882-.633-.13-1.294-.083-1.897.14-.273-.587-.704-1.086-1.245-1.44S11.647 1.62 11 1.604c-.646.017-1.273.213-1.813.568s-.969.854-1.24 1.44c-.604-.223-1.264-.27-1.896-.14-.635.13-1.218.436-1.687.882-.445.468-.751 1.053-.882 1.687-.13.633-.083 1.294.14 1.897-.587.273-1.086.705-1.44 1.245-.354.54-.55 1.17-.569 1.816.017.647.215 1.276.568 1.817.354.54.853.972 1.44 1.245-.224.604-.27 1.264-.14 1.896.13.635.436 1.219.882 1.687.468.445 1.053.882-1.687.13-.633.083-1.294-.14-1.897.587-.273 1.086-.705 1.44-1.245.355-.54.55-1.17.569-1.816zM9.662 14.85l-3.429-3.428 1.293-1.302 2.072 2.072 4.4-4.794 1.347 1.246z" fill="#1d9bf0"></path></g></svg>'

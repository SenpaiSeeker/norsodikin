...
class DramaboxAPI:
    ...
    async def homepage(self, page: int = 1) -> Dict[str, Any]:
        ...
        response = await self.session.get(f"{self.base_url}/api/v1/homepage", params=params)
    ...
    async def dubbed(self, classify: str = "terpopuler", page: int = 1) -> Dict[str, Any]:
        ...
        response = await self.session.get(f"{self.base_url}/api/v1/dubbed", params=params)
        return response.json()

    async def foryou(self) -> Dict[str, Any]:
        params = {"lang": self.lang}
        response = await self.session.get(f"{self.base_url}/api/v1/foryou", params=params)
        return response.json()

    async def latest(self) -> Dict[str, Any]:
        params = {"lang": self.lang}
        response = await self.session.get(f"{self.base_url}/api/v1/latest", params=params)
        return response.json()

    async def populersearch(self) -> Dict[str, Any]:
        params = {"lang": self.lang}
        response = await self.session.get(f"{self.base_url}/api/v1/populersearch", params=params)
        return response.json()
    ...
    async def detail(self, bookId: str) -> Dict[str, Any]:
        ...
        response = await self.session.get(f"{self.base_url}/api/v1/detail", params=params)
        return response.json()

    async def allepisode(self, bookId: str) -> Dict[str, Any]:
        params = {"bookId": bookId, "code": self.token}
        response = await self.session.get(f"{self.base_url}/api/v1/allepisode", params=params)
        return response.json()
